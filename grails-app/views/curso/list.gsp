        ...
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="id"
                                  title="${message(code: 'curso.id.label', default: 'Id')}"/>
                
                <g:sortableColumn property="ipModifica"
                                  title="${message(code: 'curso.ipModifica.label', default: 'Ip Modifica')}"/>
            ...
            <g:each in="${cursoInstanceList}" status="i" var="cursoInstance">
                <tr>
                    ...
                    <td><g:link action="show"
                                id="${cursoInstance.id}">${fieldValue(bean: cursoInstance, field: "id")}</g:link></td>
                    
                    <td>${fieldValue(bean: cursoInstance, field: "ipModifica")}</td>
